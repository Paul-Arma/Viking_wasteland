...
if (!isDedicated) then
{
	[] spawn
	{
		...
		{
			9999 cutText ["Welcome to VIKING PMC A3Wasteland, please wait for your client to initialize", "BLACK", 0.01];
			...
			execVM "addons\scripts\loadout.sqf";
...
if (hasInterface || isServer) then
{
	...
	[] ExecVM "Addons\VKN_Info_Menu\sMenuInit.sqf";
	...
	[] execVM "addons\tanoa_bridge\run.sqf";
