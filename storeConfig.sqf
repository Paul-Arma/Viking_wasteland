...
[
	...
	["ASP-1 Kir Rifle", "srifle_DMR_04_F", 1300],
	["ASP-1 Kir Rifle (Tan)", "srifle_DMR_04_tan_F", 1300]
];
...
[
	...
	["LIM-85 LMG", "LMG_03_F", 450],

	["SPMG MMG (Sand)", "MMG_02_sand_F", 500],
	["SPMG MMG (MTP)", "MMG_02_camo_F", 500],
	["SPMG MMG (Black)", "MMG_02_black_F", 500],
	["Navid MMG (Tan)", "MMG_01_tan_F", 550],
	["Navid MMG (Hex)", "MMG_01_hex_F", 550]
];
...
[
	...
	["Mk30 HMG .50 Low tripod", "B_HMG_01_F", 4000],
	["Mk30 HMG .50 Low tripod", "O_HMG_01_F", 4000],
	["Mk30 HMG .50 Low tripod", "I_HMG_01_F", 4000],
	// ["Mk30A HMG .50 Sentry", "B_HMG_01_A_F", 10000], // "A" = Autonomous = Overpowered
	// ["Mk30A HMG .50 Sentry", "O_HMG_01_A_F", 10000],
	// ["Mk30A HMG .50 Sentry", "I_HMG_01_A_F", 10000],
	...
	["Mk32 GMG 20mm High tripod", "B_GMG_01_high_F", 12000],
	["Mk32 GMG 20mm High tripod", "O_GMG_01_high_F", 12000],
	["Mk32 GMG 20mm High tripod", "I_GMG_01_high_F", 12000]
...
[
	...
	["APERS Tripwire Mine", "APERSTripMine_Wire_Mag", 1500],
	["APERS Bounding Mine", "APERSBoundingMine_Range_Mag", 1750],
	["APERS Mine", "APERSMine_Range_Mag", 1800],
	["Claymore Charge", "ClaymoreDirectionalMine_Remote_Mag", 1850],
	["M6 SLAM Mine", "SLAMDirectionalMine_Wire_Mag", 1850],
...
[
	...
	["PG-7VM HEAT Grenade", "RPG7_F", 400],                   // Direct damage: medium    | Splash damage: low    | Guidance: none
...
[
	...
	["Kahlia", "optic_KHS_blk", 300, "item"],
	["Kahlia (Hex)", "optic_KHS_hex", 400, "item"],
	["Kahlia (Tan)", "optic_KHS_tan", 400, "item"],
	["AMS", "optic_AMS", 300, "item"],
	["AMS (Khaki)", "optic_AMS_khk", 300, "item"],
	["AMS (Sand)", "optic_AMS_snd", 300, "item"],
	["LRPS", "optic_LRPS", 500, "item"],
	["LRPS (G Hex)", "optic_LRPS_ghex_F", 500, "item"],
	["LRPS (Tropic)", "optic_LRPS_tna_F", 500, "item"],
	["NVS", "optic_NVS", 2500, "item"],
	["TWS", "optic_tws", 13000, "item"], // To hide from store list, add "HIDDEN" after "item", like "item", "HIDDEN"]
...
[
	...
	["------------Apex Uniform------------", "error", 1, ""],
	
	["U_B_T_Soldier_F", "U_B_T_Soldier_F", 50, "uni"],
	["U_B_T_Soldier_AR_F", "U_B_T_Soldier_AR_F", 50, "uni"],
	["U_B_T_Soldier_SL_F", "U_B_T_Soldier_SL_F", 50, "uni"],
	["U_B_T_Sniper_F", "U_B_T_Sniper_F", 50, "uni"],
	["U_B_T_FullGhillie_tna_F", "U_B_T_FullGhillie_tna_F", 50, "uni"],
	["U_B_CTRG_Soldier_F", "U_B_CTRG_Soldier_F", 50, "uni"],
	["U_B_CTRG_Soldier_2_F", "U_B_CTRG_Soldier_2_F", 50, "uni"],
	["U_B_CTRG_Soldier_3_F", "U_B_CTRG_Soldier_3_F", 50, "uni"],
	["U_B_GEN_Soldier_F", "U_B_GEN_Soldier_F", 50, "uni"],
	["U_B_GEN_Commander_F", "U_B_GEN_Commander_F", 50, "uni"],
	["U_O_T_Soldier_F", "U_O_T_Soldier_F", 50, "uni"],
	["U_O_T_Officer_F", "U_O_T_Officer_F", 50, "uni"],
	["U_O_T_Sniper_F", "U_O_T_Sniper_F", 50, "uni"],
	["U_O_T_FullGhillie_tna_F", "U_O_T_FullGhillie_tna_F", 50, "uni"],
	["U_O_V_Soldier_Viper_F", "U_O_V_Soldier_Viper_F", 50, "uni"],
	["U_O_V_Soldier_Viper_hex_F", "U_O_V_Soldier_Viper_hex_F", 50, "uni"],
	["U_I_C_Soldier_Para_1_F", "U_I_C_Soldier_Para_1_F", 50, "uni"],
	["U_I_C_Soldier_Para_2_F", "U_I_C_Soldier_Para_2_F", 50, "uni"],
	["U_I_C_Soldier_Para_3_F", "U_I_C_Soldier_Para_3_F", 50, "uni"],
	["U_I_C_Soldier_Para_4_F", "U_I_C_Soldier_Para_4_F", 50, "uni"],
	["U_I_C_Soldier_Para_5_F", "U_I_C_Soldier_Para_5_F", 50, "uni"],
	["U_I_C_Soldier_Bandit_1_F", "U_I_C_Soldier_Bandit_1_F", 50, "uni"],
	["U_I_C_Soldier_Bandit_2_F", "U_I_C_Soldier_Bandit_2_F", 50, "uni"],
	["U_I_C_Soldier_Bandit_3_F", "U_I_C_Soldier_Bandit_3_F", 50, "uni"],
	["U_I_C_Soldier_Bandit_4_F", "U_I_C_Soldier_Bandit_4_F", 50, "uni"],
	["U_I_C_Soldier_Bandit_5_F", "U_I_C_Soldier_Bandit_5_F", 50, "uni"],
	["U_I_C_Soldier_Camo_F", "U_I_C_Soldier_Camo_F", 50, "uni"],
	["U_C_man_sport_1_F", "U_C_man_sport_1_F", 50, "uni"],
	["U_C_man_sport_2_F", "U_C_man_sport_2_F", 50, "uni"],
	["U_C_man_sport_3_F", "U_C_man_sport_3_F", 50, "uni"],
	["U_C_Man_casual_1_F", "U_C_Man_casual_1_F", 50, "uni"],
	["U_C_Man_casual_2_F", "U_C_Man_casual_2_F", 50, "uni"],
	["U_C_Man_casual_3_F", "U_C_Man_casual_3_F", 50, "uni"],
	["U_C_Man_casual_4_F", "U_C_Man_casual_4_F", 50, "uni"],
	["U_C_Man_casual_5_F", "U_C_Man_casual_5_F", 50, "uni"],
	["U_C_Man_casual_6_F", "U_C_Man_casual_6_F", 50, "uni"],
	["U_B_CTRG_Soldier_urb_1_F", "U_B_CTRG_Soldier_urb_1_F", 50, "uni"],
	["U_B_CTRG_Soldier_urb_2_F", "U_B_CTRG_Soldier_urb_2_F", 50, "uni"],
	["U_B_CTRG_Soldier_urb_3_F", "U_B_CTRG_Soldier_urb_3_F", 50, "uni"]
...
[
	...
	["Prowler (Doorless)", "B_CTRG_LSV_01_light_F", 1300, "vehicle"],
	["Prowler", "B_T_LSV_01_unarmed_F", 1300, "vehicle"],
	["Qilin", "O_T_LSV_02_unarmed_F", 1400, "vehicle"],
	...
	["UGV Stomper RCWS (NATO)", "B_UGV_01_rcws_F", 80000, "vehicle"],
	["UGV Stomper (AAF)", "I_UGV_01_F", 50000, "vehicle"],
	["UGV Stomper RCWS (AAF)", "I_UGV_01_rcws_F", 80000, "vehicle"],
...
[
	...
	["Prowler HMG", "B_T_LSV_01_armed_F", 10000, "vehicle"],
	["Qilin Minigun", "O_T_LSV_02_armed_F", 10000, "vehicle"],
...
[
	...
	["MQ4A Greyhawk Bomber UAV", "B_UAV_02_CAS_F", 50000, "vehicle"], // Bomber UAVs are a lot harder to use, hence why they are cheaper than Missile ones
	["K40 Ababil-3 Missile UAV (CSAT)", "O_UAV_02_F", 50000, "vehicle"],
	["K40 Ababil-3 Bomber UAV (CSAT)", "O_UAV_02_CAS_F", 60000, "vehicle"],
	["K40 Ababil-3 Missile UAV (AAF)", "I_UAV_02_F", 50000, "vehicle"],
...
[
	...
	[ // MH-9 colors
		...
		[
		    ["VKN SKIN", "client\images\VKN\VKN_LB.jpg"],
	...
	[ // Hellcat 
		...
		[
			["VKN SKIN", "client\images\VKN\VKN_Hellcat.jpg"]
		]
	],	
	...
	[ // SUV
		"C_SUV_01_F",
		[
			["VKN SKIN", "client\images\VKN\VKN_SUV.jpg"]
		]
	],
    ...
    [ // Offroad
		"C_Offroad_01_F",
		[
			["VKN SKIN", "client\images\VKN\VKN_offroad.jpg"]
		]
	],
	[ // Offroad ARMED
	...
	[ // Hatchback
		"C_Hatchback_01_F",
		[
			["VKN SKIN", "client\images\VKN\VKN_Hatchback.jpg"]
		]
	],
	[ // Hatchback Sport
	...
	[ // HUNTER
		"B_MRAP_01_F",
		[
			["VKN SKIN", "client\images\VKN\VKN_Hunter_Av.jpg"]
		]
	],
	[ // HUNTER
		"B_MRAP_01_hmg_F",
...
[
	...
	["Spawn Beacon", "spawnbeacon", localize "STR_WL_ShopDescriptions_spawnBeacon", "client\icons\spawnbeacon.paa", 5000, 750],
